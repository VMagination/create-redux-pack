...
var getIt = function getIt(obj, path) {
  var defaultValue = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;

  if (path === '') {
    console.log(obj, defaultValue);
    return obj !== null && obj !== void 0 ? obj : defaultValue;
  }

  if (obj && _typeof_1(obj) !== 'object' || !obj) return defaultValue;
...
var addStateParam = function addStateParam(obj, key, payloadMap, name, payload, state) {
  var _payloadMapByKey$key;

  var prefix = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : '';
  var payloadMapByKey = payloadMap[key];
  var param = (_payloadMapByKey$key = payloadMapByKey === null || payloadMapByKey === void 0 ? void 0 : payloadMapByKey.key) !== null && _payloadMapByKey$key !== void 0 ? _payloadMapByKey$key : key;
  var modification = payloadMapByKey === null || payloadMapByKey === void 0 ? void 0 : payloadMapByKey.modifyValue;
  var payloadValue = (param !== null && param !== void 0 ? param : null) !== null ? getIt(payload, param, payloadMapByKey === null || payloadMapByKey === void 0 ? void 0 : payloadMapByKey.fallback) : payload !== null && payload !== void 0 ? payload : payloadMapByKey === null || payloadMapByKey === void 0 ? void 0 : payloadMapByKey.fallback;
...
var createReduxPack = Object.assign(function (infoRaw) {
    ...
    simple: {
      actions: function actions(_ref17) {
        var name = _ref17.name,
            formatPayload = _ref17.formatPayload;
        return {
          set: createAction(createReduxPack.getSetName(name), formatPayload),
          reset: createAction(createReduxPack.getResetName(name))
        };
      },
      actionNames: function actionNames(_ref18) {
      ...
      selectors: function selectors(_ref19) {
        var name = _ref19.name,
            reducerName = _ref19.reducerName,
            _ref19$payloadMap = _ref19.payloadMap,
            payloadMap = _ref19$payloadMap === void 0 ? {} : _ref19$payloadMap;
      ...
      initialState: function initialState(_ref20) {
        var name = _ref20.name,
            _ref20$defaultInitial = _ref20.defaultInitial,
            defaultInitial = _ref20$defaultInitial === void 0 ? null : _ref20$defaultInitial,
            _ref20$payloadMap = _ref20.payloadMap,
            payloadMap = _ref20$payloadMap === void 0 ? {} : _ref20$payloadMap;
        return objectSpread2(defineProperty({}, createReduxPack.getValueName(name), defaultInitial), getInitial(payloadMap, name));
      },
      stateNames: function stateNames(_ref21) {
        var name = _ref21.name,
            _ref21$payloadMap = _ref21.payloadMap,
            payloadMap = _ref21$payloadMap === void 0 ? {} : _ref21$payloadMap;
        return objectSpread2({
          value: createReduxPack.getValueName(name)
        }, getStateNames(payloadMap, name));
      },
      reducer: function reducer(_ref22) {
        var _ref24;

        var name = _ref22.name,
            _ref22$defaultInitial = _ref22.defaultInitial,
            defaultInitial = _ref22$defaultInitial === void 0 ? null : _ref22$defaultInitial,
            _ref22$payloadMap = _ref22.payloadMap,
            payloadMap = _ref22$payloadMap === void 0 ? {} : _ref22$payloadMap;
        return _ref24 = {}, defineProperty(_ref24, createReduxPack.getSetName(name), createReducerCase(function (state, _ref23) {
          var payload = _ref23.payload;

          var newState = defineProperty({}, createReduxPack.getValueName(name), payload);

          addMappedPayloadToState(newState, payloadMap, name, payload, state);
          return newState;
        })), defineProperty(_ref24, createReduxPack.getResetName(name), createReducerCase(function () {
          return objectSpread2(defineProperty({}, createReduxPack.getValueName(name), defaultInitial), getInitial(payloadMap, name));
        })), _ref24;
      }
    }
  ...
  getSetName: function getSetName(name) {
    return "set ".concat(name);
  },
  getResetName: function getResetName(name) {
  ...
  getValueName: function getValueName(name) {
