    ...
    simple: {
      actions: function actions(_ref20) {
        var name = _ref20.name,
            formatPayload = _ref20.formatPayload;
        return {
      ...
      reducer: function reducer(_ref25) {
        ...
        return _ref27 = {}, defineProperty(_ref27, createReduxPack.getSetName(name), createReducerCase(function (state, _ref26) {
          ...
          var newState = defineProperty({}, createReduxPack.getValueName(name), mergePayloadWithResult(state[createReduxPack.getValueName(name)], payload, mergeByKey));
