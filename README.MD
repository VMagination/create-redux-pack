...
### Packages generates everything yet it's not overgenerated
...
| modifyValue | (value, prevValue, action: { code }) => State | used to set new value according or using previous value, *overrides mergeByKey* |
