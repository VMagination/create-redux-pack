...
export declare type CreateReduxPackParams<S, PayloadMain, RealType extends CRPackRealType<S> = any> = {
    name: string;
    resultInitial?: any;
    reducerName: string;
...
export declare type CreateReduxPackGeneratorBlock<RT = any> = <S = Record<string, any>, PayloadMain = Record<string, any>, RTD = Record<string, any>, RealType extends CRPackRealType<S> = any>(info: CreateReduxPackParams<S, PayloadMain, RealType>) => RT | RTD;
...
export declare type CRPackRealType<S> = Record<string | keyof S, any>;
declare type CRPackPayloadMapItem<T, RealType extends CRPackRealType<T>> = {
    initial: T;
...
export declare type CreateReduxPackPayloadMap<S, RealType extends CRPackRealType<S> = any> = {
...
declare type CreateReduxPackSelector<S, RealType extends CRPackRealType<S>> = {
    [P in keyof S]: S[P] extends Record<string, any> ? OutputSelector<any, 'formatSelector' extends keyof RealType[P] ? ReturnType<RealType[P]['formatSelector']> : S[P], any> & CreateReduxPackSelector<S[P], RealType[P]> : OutputSelector<any, 'formatSelector' extends keyof RealType[P] ? ReturnType<RealType[P]['formatSelector']> : S[P], any>;
};
export declare type CreateReduxPackSelectors<S, RealType extends CRPackRealType<S> = any> = {
...
export declare type CreateReduxPackReturnType<S, PayloadRun, PayloadMain, RealType extends CRPackRealType<S> = any> = {
    ...
    withGenerator: <Gen = Record<string, any>>(generator: {
        ...
        [P in keyof CreateReduxPackCombinedGenerators<Gen, S, PayloadRun, PayloadMain, RealType>]: CreateReduxPackCombinedGenerators<Gen, S, PayloadRun, PayloadMain, RealType>[P];
    };
};
export declare type CreateReduxPackFn = <S = Record<string, any>, PayloadRun = void, PayloadMain = Record<string, any>, RealType extends CRPackRealType<S> = any>(info: CreateReduxPackParams<S, PayloadMain, RealType>) => CreateReduxPackReturnType<S, PayloadRun, PayloadMain, RealType>;
...
export declare type CreateReduxPackType = {
    ...
    withGenerator: <S, PayloadRun, PayloadMain, Gen, RealType extends CRPackRealType<S> = any>(info: CreateReduxPackParams<S, PayloadMain, RealType>, generator: {
        [P in Exclude<keyof Gen, 'name'>]: (info: CreateReduxPackParams<S, PayloadMain, RealType>) => Gen[P];
    }) => {
        [P in keyof CreateReduxPackCombinedGenerators<Gen, S, PayloadRun, PayloadMain, RealType>]: CreateReduxPackCombinedGenerators<Gen, S, PayloadRun, PayloadMain, RealType>[P];
    };
};
export declare type CreateReduxPackCombinedGenerators<Gen, S, PayloadRun, PayloadMain, RealType extends CRPackRealType<S> = any> = CreateReduxPackReturnType<S, PayloadRun, PayloadMain, RealType> & Gen;
export {};
